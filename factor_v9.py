# -*- coding: utf-8 -*-
"""
多因子Alpha量化交易系统 v9.0 (去掉跟踪止盈版)
==============================================
核心发现(v8):
- 跟踪止盈: 3笔, 平均-5.51%, 胜率0% ❌ 必须去掉
- 固定止盈: 5笔, 平均+26.26%, 胜率100% ✅
- 止损: 5笔, 平均-14.93% ❌ 需要优化
...
def run_backtest(stocks, start_date='2024-01-01', end_date='2026-03-20', 
                 initial_cash=1000000, stop_loss=0.10, take_profit=0.25, 
...
if __name__ == '__main__':
    log("=" * 60)
    log("多因子Alpha量化交易系统 v9.0 (去掉跟踪止盈版)")
    log("=" * 60)
