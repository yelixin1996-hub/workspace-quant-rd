# -*- coding: utf-8 -*-
"""
多因子Alpha量化交易系统 v10.0 (提高止盈目标版)
===============================================
v9发现: 到期卖出30笔,平均+1.60% — 20天持有期太长了!
...
def run_backtest(stocks, start_date='2024-01-01', end_date='2026-03-20', 
                 initial_cash=1000000, stop_loss=0.10, take_profit=0.30, 
                 max_hold=15, min_score=90):
...
if __name__ == '__main__':
    log("=" * 60)
    log("多因子Alpha量化交易系统 v10.0 (提高止盈目标版)")
    log("=" * 60)
