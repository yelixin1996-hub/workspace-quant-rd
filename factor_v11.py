# -*- coding: utf-8 -*-
"""
多因子Alpha量化交易系统 v11.0 (无止损版)
===============================================
核心发现(v10):
- 止损: 15笔, 平均-11.08%, 0%胜率 ❌ 亏损根源
- 止盈: 3笔, 平均+32.60%, 100%胜率 ✅
- 到期: 33笔, 平均+2.93%, 52%胜率
...
def quick_scan(stocks, date_range=['2024-01-01', '2024-06-01']):
    ...
    for take_profit, max_hold, min_score in params:
        ...
        if annual > best_annual:
            ...
            log(f"*** 新最佳: 年化{annual:.2f}% 止盈{take_profit} 持有{max_hold}")
